				...
				<tbody>
							...
							elseif($row['programme'] == 3)
							{
		          			...
		          			<tr>
		            				...
		            				<td> Needs FA's recommendation </td>
		          			</tr>
		        		</tbody>
		      	</table>

		      	<div id="actions" style="margin-top:30px;">
			      	<a href="fa_accept.php?appno=<?php echo $app_no; ?>" class="waves-effect waves-light btn-large right green"><i class="material-icons right">thumb_up</i>Recommend</a>
				<a href="fa_reject.php?appno=<?php echo $app_no; ?>" class="waves-effect waves-light btn-large left red"><i class="material-icons right">thumb_down</i>Don't Recommend</a>
			</div>
